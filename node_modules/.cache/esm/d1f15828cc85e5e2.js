let mongoose,orderSchema,orderItemSchema;_cc8‍.x([["addOrders",()=>addOrders],["getOrderById",()=>getOrderById],["getcountOrder",()=>getcountOrder],["updateOrders",()=>updateOrders],["getOrders",()=>getOrders],["getTotalesales",()=>getTotalesales],["deleteOrderById",()=>deleteOrderById],["userOderById",()=>userOderById]]);_cc8‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_cc8‍.w("../models/orders",[["default",["orderSchema"],function(v){orderSchema=v}]]);_cc8‍.w("../models/oder-item",[["default",["orderItemSchema"],function(v){orderItemSchema=v}]]); 
...
const addOrders = async (req ,res) =>  {
 ...
 _cc8‍.g.console.log("order item id est ===>" ,orderItemsIds)
...
//  Promise.all  recoit un tableau de promesse et renvoi dans un tableau avec les valeurs de la promesse .
 // totalPrices est un tableau des prix totaux pour chaque article de commande...
     const totalPrices = await Promise.all(orderItemsIdsResolved.map(async (orderItemId)=>{ 
        ...
        _cc8‍.g.console.log("My orderItem est ==>", orderItem ) 
        _cc8‍.g.console.log("le prix et la quantite sont ==>" ,  orderItem.product.price,orderItem.quantity )
         const totalPrice = orderItem.product.price * orderItem.quantity;
         return totalPrice
     }))  

     // totalPrices est un tableau avec les valeurs de la promesse 
    _cc8‍.g.console.log("total prices est ==>", totalPrices) 

 // Calcule du cout total des commandes ...
     const totalPrice = totalPrices.reduce((a,b) => a +b , 0);
     _cc8‍.g.console.log(" cout total definitif price est ==>", totalPrice  )
   ...
   let order = new Order(
         ...
         _cc8‍.g.console.log("Mes nouveaux commandes à ajoutés sont ==>" , order) ;
         await order.save() 
    if(order) {
        res.status(201).json( {
