let mongoose,userSchema,bcrypt,jwt,dotenv;_cc8‍.x([["UserInscription",()=>UserInscription],["deleteUserById",()=>deleteUserById],["getUserCount",()=>getUserCount],["UserConnection",()=>UserConnection],["getUser",()=>getUser],["getUserById",()=>getUserById]]);_cc8‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_cc8‍.w("../models/user",[["default",["userSchema"],function(v){userSchema=v}]]);_cc8‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_cc8‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_cc8‍.w("dotenv",[["default",["dotenv"],function(v){dotenv=v}]]);
...
const UserInscription = async (req ,res) => {
    try {  
        ...
        _cc8‍.g.console.log("Mes datas sont ==>" ,
        name  ,
        email ,
        passwordHash  ,
        phone  ,
